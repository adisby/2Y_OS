 ...
 */
	u32 start_text, end_text, start_data, end_data, start_stack; /**
					*	the information about elf
					*	working for brk system call
					*/
	u32	brk;	/* the size of the text segment and data segment */

/*	file system info 
 */
	struct inode * pwd;		/* inode of current working directory */
