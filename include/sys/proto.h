...
/* fs/read_write.c */
PUBLIC int		do_rdwt();
PUBLIC void		alloc_zone_for_cmd_tar (struct inode * pin, int start, int nr);
...
/* mm/exec.c */
PUBLIC int		do_exec();
PUBLIC void		initial_brk (int pid, u32 start_text, u32 end_text, u32 start_data, u32 end_data);


/* mm/memory.c */
PUBLIC void copy_on_write(u32 l, u32 r, u32 size);
PUBLIC void verify_area(u32 address, int size);
PUBLIC void do_no_page(u32 error_code, u32 address);
PUBLIC void do_wp_page(u32 error_code, u32 address);
PUBLIC void free_page_tables(u32 start, u32 size);
