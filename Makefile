...
CFLAGS		= -I include/ -I include/sys/ -g -c -fno-builtin -Wall -fno-stack-protector -gdwarf-2 -g3#magic gcc option that make the kernel.bin 3 times larger
...
OBJS		= kernel/kernel.o kernel/start.o kernel/main.o\
			...
			lib/syslog.o\
			mm/main.o mm/forkexit.o mm/exec.o mm/memory.o mm/break.o\
			fs/main.o fs/open.o fs/misc.o fs/read_write.o\
			fs/link.o fs/fs_stat.o\
			fs/disklog.o
LOBJS		=  lib/syscall.o\
			lib/printf.o lib/vsprintf.o\
			lib/string.o lib/misc.o\
			lib/open.o lib/dir.o lib/closedir.o lib/seekdir.o lib/rewinddir.o lib/getcwd.o lib/read.o lib/write.o lib/close.o lib/unlink.o \
			lib/lseek.o\
			lib/getpid.o lib/stat.o\
			lib/fork.o lib/exit.o lib/wait.o lib/exec.o lib/malloc.o lib/readdir.o lib/chdir.o lib/brk.o
...
lib/closedir.o: lib/closedir.c
	$(CC) $(CFLAGS) -o $@ $<

lib/rewinddir.o: lib/rewinddir.c
	$(CC) $(CFLAGS) -o $@ $<

lib/getcwd.o: lib/getcwd.c
	$(CC) $(CFLAGS) -o $@ $<

lib/seekdir.o: lib/seekdir.c
	$(CC) $(CFLAGS) -o $@ $<
